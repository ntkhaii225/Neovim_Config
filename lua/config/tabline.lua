...
local _tab_invalidate_events = {
	...
	"BufDelete",
	"BufWipeout",
	"BufFilePost",   -- Khi đổi tên file
	"BufWritePost",  -- Khi lưu file (giúp cập nhật trạng thái [+][-])
	"BufEnter",      -- Khi chuyển đổi giữa các buffer
	"OptionSet",     -- Kích hoạt khi bất kỳ option nào thay đổi (bao gồm 'modified')
}
